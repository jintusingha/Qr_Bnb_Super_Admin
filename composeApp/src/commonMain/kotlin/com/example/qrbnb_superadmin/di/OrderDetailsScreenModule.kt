...
import com.example.qrbnb_superadmin.data.remote.service.RealOrderDetailDataSource
...
val OrderDetailsScreenModule =
    module {
        ...
        single<OrderDataSource> {
            RealOrderDetailDataSource(httpClient = get(POST_LOGIN_CLIENT), baseUrl = get(named("BASE_URL")))
